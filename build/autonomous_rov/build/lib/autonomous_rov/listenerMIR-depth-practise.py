...
class MyPythonNode(Node):
    def __init__(self):
        ...
        # # PWM to thrust conversion parameters 12 V
        self.pwm_pos_intercept = 1536.00
        self.pwm_pos_slope = 9.80
        self.pwm_neg_intercept = 1464.49
        self.pwn_neg_slope = 12.36

        # # PWM to thrust conversion parameters 14 V
        # self.pwm_pos_intercept = 1534.87
        # self.pwm_pos_slope = 8.07
        # self.pwm_neg_intercept = 1468.00
        # self.pwn_neg_slope = 10.41
    ...
    def RelAltCallback(self, data):
        ...
        if self.last_rel_alt_time is not None:
            dt_test = current_time - self.last_rel_alt_time
            sampling_rate = 1.0 / dt_test
        ...
        msg = Float64()
        msg.data = correction_force
        self.pub_thruster_force.publish(msg)
    ...
    def cubic_trajectory(self):
        ...
        msg = Float64()
        msg.data = z_des
        self.pub_desired_depth.publish(msg)
        msg = Float64()
        msg.data = z_dot_des
        self.pub_desired_heave.publish(msg)
