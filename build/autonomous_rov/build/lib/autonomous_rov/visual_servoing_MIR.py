...
class MyPythonNode(Node):
    ...
    def trackerCallback(self, data):
        ...
        error_vs = np.array([self.tracked_point[0] - self.desired_point[0], self.tracked_point[1] - self.desired_point[1]])
        # Calculate the interaction matrix
        ...
        pruner_vcam = np.array([1, 0, 0, 0, 0, 0]) # v cam = [sway, heave, surge, pitch, sway, roll] I think
